 ...
 */
class DocumentVersionToIdTransformer extends \DevBieres\CommonBundle\Form\Transformer\AbstractEntityToIdTransformer
{
		...
		protected function getEntityFullName() { 
				return "DevBieresSpecsBaseBundle:DocumentVersion";
		} // /getEntityFullName
