...
class ActorService extends BaseService implements IEntityFormService
{
     ...
     * FullName
	 */
    protected function getFullEntityName() { return 'DevBieres\Specs\BaseBundle\Entity\Actor'; }

    /**
	 * Get the document form
	 */
	public function getForm() { return new \DevBieres\Specs\BaseBundle\Form\ActorType(); }

	/**
	 * Return all actors for document
